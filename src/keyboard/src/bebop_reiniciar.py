...
import random
import pandas as pd
from std_srvs.srv import Empty as Empty2
class keyboard:
	def __init__(self):
		...
		self.reset_proxy = rospy.ServiceProxy('gazebo/reset_simulation', Empty2)
		self.vel_msg = Twist()
		self.OvR_msg = 0
	...
	def cmd_vel(self):
		...
		while not rospy.is_shutdown():
			while num_episodio<MAX_EPISODES:
				...
				excel_file_path = '/home/nilda/Documentos/archivos/data_reiniciar.xlsx'
