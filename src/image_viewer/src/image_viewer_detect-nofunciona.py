...
class image_viewer:
	def __init__(self):
		...
		'''
		self.model_path = '/home/nilda/IntRob2023/deep_learning/yolo-cono/runs/detect/train3/weights/best.pt'
		self.model = "a"#YOLO(self.model_path)  # load a custom model
		self.threshold = 0.5
		self.class_name_dict = {0: 'dog', 1: 'person', 2: 'cat', 3: 'tv', 4: 'car', 5: 'meatballs', 6: 'marinara sauce', 7: 'tomato soup', 8: 'chicken noodle soup', 9: 'french onion soup', 10: 'chicken breast', 11: 'ribs', 12: 'pulled pork', 13: 'hamburguer', 14: 'cavity', 15: 'cono',16:'basura'}
		'''
	...
	def callback(self,data):
		...
		'''
		scale = frame#cv2.resize(frame, (320, 240))
		...
		try:
			...
			cv2.waitKey(1)
			#cv2.imwrite("detecting.jpg", scale)
			print("pasa")
