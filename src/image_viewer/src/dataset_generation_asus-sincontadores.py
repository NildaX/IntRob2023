...
class image_viewer:
	def __init__(self):
		...
		self.model_path = '/home/nilda/IntRob2023/deep_learning/yolo-proyecto/runs/detect/train-new/weights/best.pt'
	...
	def recognized_object(self,data):
		...
		for result in results.boxes.data.tolist():
		    ...
		    if score > self.threshold:
				...
				if name_actual==self.class_name_dict[int(class_id)]:
					self.count_image+=1
