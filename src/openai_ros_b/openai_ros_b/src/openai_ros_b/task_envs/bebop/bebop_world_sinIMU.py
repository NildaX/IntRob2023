...
##--------------revisar
GAZEBO_WORLD_LAUNCH_NAME = "text_city2"
...
class BebopWorldEnv(bebop_env.BebopEnv):
    ...
    def _get_obs(self):
        ...
        distance_to_des_point = self.repre_state[6]#round(self.previous_distance_from_des_point, 2)
        angle_to_des_point = self.repre_state[7]#round(self.previous_angle_from_des_point, 2)
