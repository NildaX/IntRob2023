...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=10000):
    ...
    if task_env == 'TurtleBot2Maze-v0':
        ...
        register(
            id=task_env,
            entry_point='openai_ros_b.task_envs.turtlebot2.turtlebot2_maze:TurtleBot2MazeEnv',
            max_episode_steps=max_episode_steps,
        )
        # import our training environment
        from openai_ros_b.task_envs.turtlebot2 import turtlebot2_maze

    elif task_env == 'MyTurtleBot2Wall-v0':

        register(
            id=task_env,
            entry_point='openai_ros_b.task_envs.turtlebot2.turtlebot2_wall:TurtleBot2WallEnv',
            max_episode_steps=max_episode_steps,
        )
        # import our training environment
        from openai_ros_b.task_envs.turtlebot2 import turtlebot2_wall

    elif task_env == 'MyTurtleBot2WillowGarage-v0':

        register(
            id=task_env,
            entry_point='openai_ros_b.task_envs.turtlebot2.turtlebot2_willow_garage:TurtleBot2WillowGarageEnv',
            max_episode_steps=max_episode_steps,
        )
        # import our training environment
        from openai_ros_b.task_envs.turtlebot2 import turtlebot2_willow_garage

    elif task_env == 'bebopTraining-v0':
        register(
            id=task_env,
            entry_point='openai_ros_b.task_envs.bebop.bebop_world:BebopWorldEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros_b.task_envs.bebop import bebop_world
...
def GetAllRegisteredGymEnvs():
    ...
    #env_ids = envs.registry.keys() #la nueva version de gym
