...
class RobotGazeboEnv(gym.Env):
    ...
    def reset(self,num_episode=0):
        ...
        #print("------------Reseting RobotGazeboEnvironment",num_episode)
        #rospy.sleep(2)
        if(num_episode>1):
            self._reset_sim()
        else:
        ...
        return obs
    def get_state_gazebo(self):
        return self.repre_state_gazebo
    def reset_sin_reset(self):
        #print("reset sin reset")
        obs = self._get_obs()
        rospy.logdebug("END Reseting RobotGazeboEnvironment")
        return obs
    def close(self):
    ...
    def _reset_sim(self):
        ...
        print("RESET SIM START",self.reset_controls)
        if self.reset_controls :
            ...
            #print("gazebo.unpauseSim")
            self.gazebo.unpauseSim()


            #print("_check_all_systems_ready")
            self._check_all_systems_ready()
