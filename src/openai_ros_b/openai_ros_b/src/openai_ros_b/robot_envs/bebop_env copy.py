...
class BebopEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self, ros_ws_abspath):
        ...
        * /scan: Laser Readings
        ...
        ROSLauncher(rospackage_name="rotors_gazebo",
                    launch_file_name="test_bebop.launch",
                    ros_ws_abspath=ros_ws_abspath)
        # Internal Vars
        ...
        rospy.Subscriber("/bebop2/front_camera/rgb/image_raw", Image, self._image_rgb_callback)
        rospy.Subscriber("/bebop2/front_camera/depth/image_raw", Image, self.depth_image_callback, queue_size=1, buff_size=2**24)
    ...
    def pose_callback(self,data):
        ...
        self.repre_state[8] = model_states.pose[index].position.z
        (self.repre_state[12], self.repre_state[13], self.repre_state[14]) = euler_from_quaternion([model_states.pose[index].orientation.x,model_states.pose[index].orientation.y,model_states.pose[index].orientation.z, model_states.pose[index].orientation.w])
