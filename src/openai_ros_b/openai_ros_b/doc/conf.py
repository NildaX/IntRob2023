# -*- coding: utf-8 -*-
#
# openai_ros_b documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'openai_ros_b.tex', u'openai\\_ros Documentation',
...
man_pages = [
    (master_doc, 'openai_ros_b', u'openai_ros_b Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'openai_ros_b', u'openai_ros_b Documentation',
     author, 'openai_ros_b', 'One line description of project.',
     'Miscellaneous'),
]
